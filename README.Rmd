...
transcriptomic-oriented objects, focusing on data.tables (DT). This enables a 
quick and simplified analysis, to closely inspection summary metrics per 
transcript, at nucleotide resolution, i.e. coverage, read-starts, read-ends,
deletions, and nucleotide frequency.
