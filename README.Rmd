...
mappings) that cover a gene. 
this is now easily done and provided as the `tx_counts()` function.
...
tables that span the whole transcript with summarized information such as:
...
The `tx_covNucFreqDT()` function creates such tables adding both the genomic
and transcriptomic coordinates system.
