...
quick and simplified analysis, to closely inspect summarized RNA-seq data per 
...
In this small example we will use the 'Pasilla' experiment data (from its own package)
...
Then we just need to summarize the alignments into a DT. In this case using
