...
Transcript-wise data analysis is increasingly needed
...
**txtools** is a package that processes `GenomicAlignment` objects into their 
transcriptomic counterparts, and facilitate their analysis through different
transcript-wise functions.
